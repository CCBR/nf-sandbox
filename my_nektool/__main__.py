...
\b
CLUSTER EXECUTION:
my_nektool run ... -profile [profile],[profile],...
For information on Nextflow config and profiles see:
https://www.nextflow.io/docs/latest/config.html#config-profiles
\b
RUN EXAMPLES:
Required:           my_nektool run --input [file]
Specify threads:    my_nektool run ... --threads [threads]
Enable conda:       my_nektool run ... --use-conda 
Add NextFlow args:  my_nektool run ... -work-dir workDir -with-docker
"""
